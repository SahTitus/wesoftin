...
function UserProfileList() {
  ...
  return (
    <UserContext.Provider value={selectedUser}>
      <div className="min-h-screen bg-white dark:bg-gray-800 flex flex-col justify-center items-center p-5">
        ...
        {filteredProfiles.length === 0 ? (
          <div>
            <h3 className="text-gray-800 dark:text-white">No User Found</h3>
          </div>
        ) : (
