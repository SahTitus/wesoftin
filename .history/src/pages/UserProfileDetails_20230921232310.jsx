  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="container mx-auto mt-6 p-4">
        <div className="bg-gray-800 rounded-lg shadow-lg p-4">
          <div className="flex items-center justify-center"> {/* Center content */}
            <Avatar name={userDetails.name} src={userDetails.profilePicture} className="w-24 h-24 md:w-32 md:h-32 rounded-full mb-4 md:mb-0" />
      ...
      <div className="bg-gray-800 py-4 text-center text-white">
        <p className="text-lg">
          Thank you for visiting the user details page. This UI uses GitHubs dark theme color.
        </p>
      </div>
    </div>
  );
